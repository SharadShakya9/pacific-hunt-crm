    ...
    <div>
      <div className="flex h-[48px] w-full items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <p className="text-18-600 text-dark-2">Experience Level</p>
        </div>
        ...
        <div className="flex gap-4">
          ...
          <Dialog>
            <DialogTrigger asChild>
              <BlueButton>
                <img src="/add.svg" alt="" /> <span>Create Experience Level</span>
              </BlueButton>
            </DialogTrigger>
              ...
              <div className="mx-[25px] mb-[80px] space-y-[20px]">
                <div className="flex flex-col gap-[8px]">
                  <Label htmlFor="experiencelevel">
                    <p className="text-16-500 text-dark-2">Experience level</p>
                  </Label>
                  <Input
                    id="experiencelevel"
